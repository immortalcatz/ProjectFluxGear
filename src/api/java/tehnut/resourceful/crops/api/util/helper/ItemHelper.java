...
public class ItemHelper {
    ...
    public static String getItemString(ItemStack stack) {
        return stack != null ? GameData.getItemRegistry().getNameForObject(stack.getItem()) + ":" + stack.getMetadata() + "#" + stack.stackSize : "null";
    }
    ...
    public static ItemStack parseItemStack(String stackString, boolean input) {
        ...
        try {
            if (stackString.contains(":")) {
                ...
                return new ItemStack(oreStack.getItem(), amount, oreStack.getMetadata());
            }
