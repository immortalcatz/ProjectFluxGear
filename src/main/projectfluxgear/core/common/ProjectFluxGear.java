...
import mortvana.projectfluxgear.resource.world.PoorOreGen;
...
import mortvana.projectfluxgear.unmodulized.common.FluxGearCompat;
...
import mortvana.projectfluxgear.unmodulized.gui.FluxGearAchievements;
import mortvana.projectfluxgear.resource.world.FluxGearWorldGenerator;
import mortvana.projectfluxgear.resource.world.GravelOreGenEventHandler;
...
public class ProjectFluxGear {
    ...
    public static final CreativeTabs tabMaterials = new FluxGearTab("PFG-Materials", "projectfluxgear.materialsTab", FluxGearContent.gemDioptase);
    public static final CreativeTabs tabWorld = new FluxGearTab("PFG-World", "projectfluxgear.worldTab", FluxGearContent.oreBauxite);
    public static final CreativeTabs tabTools = new FluxGearTab("PFG-Tools", "projectfluxgear.toolsTab", FluxGearContent.toolProtoSonicWrench);
    //MOAR Tabs?
