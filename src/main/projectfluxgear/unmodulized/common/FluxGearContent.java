package mortvana.projectfluxgear.unmodulized.common;
...
import mortvana.projectfluxgear.unmodulized.block.BlockPFGBasic.*;
import mortvana.projectfluxgear.unmodulized.block.BlockTemporalPylon;
import mortvana.projectfluxgear.unmodulized.block.BlockWoodenTileEntity;
import mortvana.projectfluxgear.unmodulized.block.itemblock.ItemBlockPFGBasic.*;
import mortvana.projectfluxgear.core.common.ProjectFluxGear;
import mortvana.projectfluxgear.core.common.config.FluxGearConfig;
import mortvana.projectfluxgear.tech.fluid.BlockFluidAcid;
import mortvana.projectfluxgear.tech.fluid.BlockFluidSmog;
import mortvana.projectfluxgear.core.item.ItemInteractivePFG;
import mortvana.mechstoneworks.item.tool.ItemPrototypeSonicWrench;
import mortvana.projectfluxgear.weirdScienceLegacy.*;
import mortvana.projectfluxgear.core.util.PFGColors;
...
public class FluxGearContent implements IFuelHandler{
    ...
    public void loadItems() {
        itemMaterial = (ItemFluxGear) new ItemFluxGear("projectfluxgear").setUnlocalizedName("material").setCreativeTab(ProjectFluxGear.tabMaterials);
        itemBucket = (BucketFluxGear) new BucketFluxGear("projectfluxgear").setUnlocalizedName("bucket").setCreativeTab(ProjectFluxGear.tabMaterials);
        itemFood = (ItemFluxGear) new ItemFluxGear("projectfluxgear").setUnlocalizedName("food").setCreativeTab(ProjectFluxGear.tabMaterials);
