...
public class BlockPFGBasic {
	...
	public static class BlockOreMain extends AdvBlockFluxGear {
		public BlockOreMain() {
			super(Material.rock, ProjectFluxGear.tabWorld, EnumBlockType.ORE, NAMES_ORES_MAIN, TEXTURES_FULL, HARDNESS_ORES, RESISTANCE_ORES, LIGHT_ORES_MAIN, TEXTURE_LOCATION_ORE);
	...
	public static class BlockOreAux extends AdvBlockFluxGear {
		public BlockOreAux() {
			super(Material.rock, ProjectFluxGear.tabWorld, EnumBlockType.ORE, NAMES_ORES_AUX, TEXTURES_FULL, HARDNESS_ORES, RESISTANCE_ORES, LIGHT_ORES_AUX, TEXTURE_LOCATION_ORE);
	...
	public static class BlockStorageMain extends AdvBlockFluxGear {
		public BlockStorageMain() {
			super(Material.iron, ProjectFluxGear.tabMaterials, EnumBlockType.STORAGE, NAMES_STORE_MAIN, TEXTURES_FULL, HARDNESS_STORE_MAIN, RESISTANCE_STORE_MAIN, LIGHT_STORE_MAIN, TEXTURE_LOCATION_BLOCK);
	...
	public static class BlockStorageAux extends AdvBlockFluxGear {
		public BlockStorageAux() {
			super(Material.iron, ProjectFluxGear.tabMaterials, EnumBlockType.STORAGE, NAMES_STORE_AUX, TEXTURES_FULL, HARDNESS_STORE_AUX, RESISTANCE_STORE_AUX, LIGHT_STORE_AUX, TEXTURE_LOCATION_BLOCK);
	...
	public static class BlockAlloyMain extends AdvBlockFluxGear {
		public BlockAlloyMain() {
			super(Material.iron, ProjectFluxGear.tabMaterials, EnumBlockType.STORAGE, NAMES_ALLOY_MAIN, TEXTURES_FULL, HARDNESS_ALLOY_MAIN, RESISTANCE_ALLOY_MAIN, LIGHT_ALLOY_MAIN, TEXTURE_LOCATION_BLOCK);
	...
	public static class BlockEarthen extends AdvBlockFluxGear {
		public BlockEarthen() {
			super(FluxGearCore.soilOre, ProjectFluxGear.tabMaterials, EnumBlockType.SOIL_ORE, NAMES_EARTH, TEXTURES_EARTH, HARDNESS_EARTH, RESISTANCE_EARTH, LIGHT_EARTH, TEXTURE_LOCATION_DEFAULT);
	...
	public static class BlockGravelOreMain extends FallingBlockFluxGear {
		...
		public BlockGravelOreMain() {
			super(FluxGearCore.soilOre, ProjectFluxGear.tabWorld, EnumBlockType.SOIL_ORE);
