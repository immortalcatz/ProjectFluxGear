...
import oldcode.projectfluxgear.to_refactor.util.legacy.block.tile.TileEntitySolidFueled;
import oldcode.projectfluxgear.to_refactor.util.legacy.item.ISolidFuelInfo;
import oldcode.projectfluxgear.to_refactor.util.legacy.item.SolidFuelInfo;
