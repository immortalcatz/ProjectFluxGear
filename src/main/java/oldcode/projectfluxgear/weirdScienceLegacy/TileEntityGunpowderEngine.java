...
import oldcode.projectfluxgear.util.legacy.block.tile.TileEntitySolidFueled;
import oldcode.projectfluxgear.util.legacy.item.ISolidFuelInfo;
import oldcode.projectfluxgear.util.legacy.item.SolidFuelInfo;
