package oldcode.legacy.client;

import com.google.common.collect.Lists;
import mortvana.projectfluxgear.thaumic.client.render.RenderPurity;
import oldcode.legacy.block.tileentity.TileCrank;
import oldcode.legacy.block.tileentity.WoodmillLogic;
import oldcode.legacy.client.particle.TRParticle;
import oldcode.legacy.client.render.DualPassCubeRenderer;
import oldcode.legacy.client.render.RenderCrank;
import oldcode.legacy.client.render.RenderFleshGolem;
import oldcode.legacy.common.CommonProxy;
import oldcode.legacy.common.MortTech;
...
import oldcode.legacy.gui.GuiWoodmill;
import oldcode.legacy.util.MTControls;
import oldcode.legacy.util.handlers.ClientTickHandler;
