...
import oldcode.legacy.common.config.FluxGearConfigWorld;
import oldcode.legacy.util.ContentRegistry;
import oldcode.legacy.util.handlers.DummyHandler;
import oldcode.legacy.util.helpers.StringHelper;
import oldcode.legacy.util.runtime.EnvironmentChecks;
import oldcode.legacy.world.FluxGearWorldGenerator;
import oldcode.legacy.world.GravelOreGenEventHandler;
import oldcode.legacy.world.PoorOreGenerator;
