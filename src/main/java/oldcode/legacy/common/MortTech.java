...
import oldcode.legacy.block.BlockBasicOre;
import oldcode.legacy.block.BlockComplexOre;
import oldcode.legacy.block.BlockGemOre;
import oldcode.legacy.block.BlockHandler;
...
import oldcode.legacy.common.config.MTConfig;
import oldcode.legacy.util.runtime.EnvironmentChecks;
import oldcode.morttech.EnvironmentChecks;
import oldcode.legacy.util.Modules;
...
//different tick handlers (for the server).
    ...
    @SidedProxy(clientSide="oldcode.legacy.client.ClientProxy", serverSide="OLD.morttech.morttech.common.MTServerProxy")
    public static oldcode.morttech.CommonProxy proxy;
