...
import mortvana.projectfluxgear.util.helpers.CraftingHelper;
...
import oldcode.legacy.block.*;
import oldcode.legacy.block.itemblock.ItemBlockBasicOre;
import oldcode.legacy.block.itemblock.ItemBlockComplexOre;
import oldcode.legacy.block.itemblock.ItemBlockGemOre;
import oldcode.legacy.block.tileentity.TileEntityGunpowderEngine;
import oldcode.legacy.block.tileentity.TileTimeyWimey;
import oldcode.legacy.block.tileentity.TileWoodmill;
import oldcode.legacy.common.config.FluxGearConfig;
import oldcode.legacy.common.config.FluxGearConfigTweaks;
import oldcode.legacy.entity.EntityFleshProjectile;
import oldcode.legacy.entity.FleshGolem;
import oldcode.legacy.item.*;
import oldcode.legacy.recipe.RecipePaintbrush;
import oldcode.legacy.util.ContentRegistry;
import oldcode.legacy.util.MTCreativeTab;
import oldcode.legacy.util.chemistry.ReactionSpec;
import oldcode.legacy.util.handlers.DispenserEmptyBucketHandler;
import oldcode.legacy.util.handlers.DispenserFilledBucketHandler;
import oldcode.legacy.util.helpers.ItemHelper;
import oldcode.legacy.util.helpers.MiscHelper;
import oldcode.legacy.util.item.*;
import oldcode.legacy.block.BlockFluxGear.*;
