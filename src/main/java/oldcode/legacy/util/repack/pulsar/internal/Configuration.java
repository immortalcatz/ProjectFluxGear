package oldcode.legacy.util.repack.pulsar.internal;
...
import oldcode.legacy.util.repack.pulsar.internal.logging.ILogger;
import oldcode.legacy.util.repack.pulsar.pulse.PulseMeta;
