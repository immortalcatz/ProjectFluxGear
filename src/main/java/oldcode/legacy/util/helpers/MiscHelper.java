...
import oldcode.legacy.util.block.fluid.ColoredFluid;
import oldcode.legacy.util.block.fluid.ColoredFluidItemBlock;
import oldcode.legacy.util.block.fluid.FluidBlock;
