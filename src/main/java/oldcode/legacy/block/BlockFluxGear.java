...
import oldcode.legacy.block.tileentity.*;
import oldcode.legacy.common.FluxGearContent;
import oldcode.legacy.common.ThaumicContent;
import oldcode.legacy.util.block.FallingBlockFluxGear;
import oldcode.legacy.util.block.tile.TileEntityBase;
import oldcode.legacy.util.chemistry.IBioactive;
import oldcode.legacy.util.chemistry.IReactionReceiver;
import oldcode.legacy.util.chemistry.IReactionSpec;
import oldcode.legacy.util.helpers.BlockHelper;
import oldcode.legacy.util.helpers.ItemHelper;
import oldcode.legacy.util.helpers.SecurityHelper;
import oldcode.legacy.util.helpers.StringHelper;
import oldcode.legacy.util.sound.ISoundProvider;
import oldcode.projectfluxgear.*;
...
public class BlockFluxGear extends Block {
	...
	public class ItemBlockPaintedStone extends ItemBlock {
		...
		public String getUnlocalizedName(ItemStack par1ItemStack) {
			return super.getUnlocalizedName() + "." + oldcode.legacy.common.ProjectFluxGear.colorNames[par1ItemStack.getItemDamage()];
		}
	}
	...
	public class BlockPlant extends Block implements IPlantable {
		public BlockPlant() {
			...
			setStepSound(Block.soundTypeGrass).setCreativeTab(oldcode.legacy.common.ProjectFluxGear.generalTab).setTickRandomly(true);
		}
	...
	public static class BlockAlloyAux extends BlockFluxGear {
		...
		public BlockAlloyAux() {
			super(Material.iron, oldcode.legacy.common.ProjectFluxGear.tabMaterials, EnumBlockType.STORAGE, NAMES_ALLOY_AUX, TEXTURES_FULL, HARDNESS_ALLOY_AUX, RESISTANCE_ALLOY_AUX, LIGHT_ALLOY_AUX, TEXTURE_LOCATION_BLOCK);
	...
	public static class BlockGravelOreMain extends FallingBlockFluxGear {
		...
		public BlockGravelOreMain() {
			super(materialSoilOre, oldcode.legacy.common.ProjectFluxGear.tabWorld, EnumBlockType.SOIL_ORE);
	...
	public class BlockNitrateEngine extends BlockContainerBase {
		...
		public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int metadata, float par1, float par2, float par3) {
			...
			player.openGui(oldcode.legacy.common.ProjectFluxGear.instance, 0, world, x, y, z);
			return true;
		}
	...
	public class BlockBloodEngine extends BlockMetaTank {
		...
		public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int metadata, float par1, float par2, float par3) {
			...
			player.openGui(oldcode.legacy.common.ProjectFluxGear.instance, guiID, world, x, y, z);
			return true;
			return false;
		}
	...
	public class BlockPaintedStone extends Block {
		...
		public void registerBlockIcons(IIconRegister iconRegister) {
			...
			for(int i = 0; i < this.icons.length; ++i) {
				this.icons[i] = iconRegister.registerIcon("mortvana.mechstoneworks:" + textureName + "_" + oldcode.legacy.common.ProjectFluxGear.colorNames[i]);
			}
	...
	public static class CongealedBloodBlock extends Block implements ISoundProvider {
		...
		public CongealedBloodBlock(Material blockMaterial) {
			...
			setCreativeTab(oldcode.legacy.common.ProjectFluxGear.tabMaterials);
	...
	public static Block blockOreMain = new BlockFluxGear(Material.rock, oldcode.legacy.common.ProjectFluxGear.tabWorld, BlockFluxGear.EnumBlockType.ORE, NAMES_ORES_MAIN, TEXTURES_FULL, HARDNESS_ORES, RESISTANCE_ORES, LIGHT_ORES_MAIN, TEXTURE_LOCATION_ORE).setBlockName("mortvana.projectfluxgear.oreMain");
	public static Block blockOreAux = new BlockFluxGear(Material.rock, oldcode.legacy.common.ProjectFluxGear.tabWorld, BlockFluxGear.EnumBlockType.ORE, NAMES_ORES_AUX, TEXTURES_FULL, HARDNESS_ORES, RESISTANCE_ORES, LIGHT_ORES_AUX, TEXTURE_LOCATION_ORE).setBlockName("mortvana.projectfluxgear.oreAux");
	public static Block blockStorageAux = new BlockFluxGear(Material.iron, oldcode.legacy.common.ProjectFluxGear.tabMaterials, EnumBlockType.STORAGE, NAMES_STORE_AUX, TEXTURES_FULL, HARDNESS_STORE_AUX, RESISTANCE_STORE_AUX, LIGHT_STORE_AUX, TEXTURE_LOCATION_BLOCK).setBlockName("mortvana.projectfluxgear.storageAux");
	public static Block blockAlloyMain = new BlockFluxGear(Material.iron, oldcode.legacy.common.ProjectFluxGear.tabMaterials, EnumBlockType.STORAGE, NAMES_ALLOY_MAIN, TEXTURES_FULL, HARDNESS_ALLOY_MAIN, RESISTANCE_ALLOY_MAIN, LIGHT_ALLOY_MAIN, TEXTURE_LOCATION_BLOCK).setBlockName("mortvana.projectfluxgear.alloyMain");
	public static Block blockStorageAdv = new BlockFluxGear(Material.iron, oldcode.legacy.common.ProjectFluxGear.tabMaterials, EnumBlockType.STORAGE, NAMES_STORE_ADV, TEXTURES_FULL, HARDNESS_STORE_ADV, RESISTANCE_STORE_ADV, LIGHT_STORE_ADV, TEXTURE_LOCATION_BLOCK).setBlockName("mortvana.projectfluxgear.storageAdv");
	public static Block blockStorageAlch = new  BlockFluxGear(Material.iron, oldcode.legacy.common.ProjectFluxGear.tabMaterials, EnumBlockType.STORAGE, NAMES_STORE_ALCH, TEXTURES_FULL, HARDNESS_STORE_ALCH, RESISTANCE_STORE_ALCH, LIGHT_STORE_ALCH, TEXTURE_LOCATION_BLOCK).setBlockName("mortvana.projectfluxgear.storageAux");
	public static Block blockEarthen = new BlockFluxGear(materialSoilOre, oldcode.legacy.common.ProjectFluxGear.tabMaterials, EnumBlockType.SOIL_ORE, NAMES_EARTH, TEXTURES_EARTH, HARDNESS_EARTH, RESISTANCE_EARTH, LIGHT_EARTH, TEXTURE_LOCATION_DEFAULT).setBlockName("mortvana.projectfluxgear.earthen");
	public static Block blockPoorOreMain = new BlockFluxGear(Material.rock, oldcode.legacy.common.ProjectFluxGear.tabWorld, EnumBlockType.ORE, NAMES_ORES_MAIN, TEXTURES_FULL, HARDNESS_ORES, RESISTANCE_ORES, LIGHT_ORES_MAIN, TEXTURE_LOCATION_POOR_ORE).setBlockName("mortvana.projectfluxgear.poorOreMain");
	public static Block blockPoorOreAux = new BlockFluxGear(Material.rock, oldcode.legacy.common.ProjectFluxGear.tabWorld, EnumBlockType.ORE, NAMES_ORES_AUX, TEXTURES_FULL, HARDNESS_ORES, RESISTANCE_ORES, LIGHT_ORES_AUX, TEXTURE_LOCATION_POOR_ORE).setBlockName("mortvana.projectfluxgear.poorOreAux");
