...
public class MechStoneworksConfig {
	...
	public static void loadConfig (File file) {
		MechanicsStoneworks.logger.info("Loading configuration from disk.");
		...
		config.save();
		MechanicsStoneworks.logger.info("Configuration load completed.");
	}
}
