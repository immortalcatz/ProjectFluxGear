package mortvana.mechstoneworks.item.tool;
...
public class ItemPaintbrush extends Item {
	...
	IIcon bristles;
	public static final int[] dyeColors = new int[]{ 16777215, 14383931, 13972141, 6921443, 12036905, 4832573, 13400208, 6118749, 10660008, 5287101, 10045406, 3559620, 7620651, 4612892, 14101287, 2105376 };
	ItemStack dyeType;
	...
	private boolean colorBlocks(ItemStack stack, EntityLivingBase player, World world, int x, int y, int z, int paintRadius) {
		...
		if(stack.hasTagCompound()) {
			int type = stack.getTagCompound().getInteger("PaintType");
				if(type != 0) {
				int max = 1728 - damage;
				int amount = MechanicsStoneworks.instance.colorStoneBlocks(world, x, y, z, type - 1, paintRadius, max);
				if(amount > 0) {
