...
public abstract class MultiblockTileEntityBase extends IMultiblockPart {
	...
	public void assertDetached() {
		if(this.controller != null) {
			FluxGearCore.log.info("[assert] Part @ (%d, %d, %d) should be detached already, but detected that it was not. This is not a fatal error, and will be repaired, but is unusual.", xCoord, yCoord, zCoord);
	 ...
	 * @see mortvana.fluxgearcore.util.multiblock.repack.MultiblockTileEntityBase#decodeDescriptionPacket(NBTTagCompound)
	 */
	 ...
	 * @see mortvana.fluxgearcore.util.multiblock.repack.MultiblockTileEntityBase#encodeDescriptionPacket(NBTTagCompound)
	 */
