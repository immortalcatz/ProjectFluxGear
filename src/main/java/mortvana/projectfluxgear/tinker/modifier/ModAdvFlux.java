package mortvana.projectfluxgear.tinker.modifier;
...
/* TE4 Support */
/*public class ModAdvFlux extends ModBoolean {
    ...
    public ModAdvFlux()
    {
        super(new ItemStack[0], 9, "Flux Infused", "\u00a7e", "");
    }
    @Override
    ...
    public void modify (ItemStack[] input, ItemStack tool)
    {
        ...
        if(!tags.hasKey(key)) {
            ...
            addModifierTip(tool, "\u00a7eFlux Infused");
        }
