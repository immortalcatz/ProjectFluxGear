package mortvana.projectfluxgear.to_refactor.util.legacy.util;
...
/* An abstraction for Minecraft's slot type. Intended to be easy and generalized to configure and use
 * with tile entities. Intended for use with our GUI system - namely, the wrapper over Container.
 *
...
public class SlotData {
	...
	public SlotData() {
		whitelist = new ArrayList<Item>(8); //Start with 8 as a capacity hint for performance reasons maybe. (Must profile, who knows?)
		blacklist = new ArrayList<Item>(8);
	}
	/*
	 * This enum can be:
	 * 
