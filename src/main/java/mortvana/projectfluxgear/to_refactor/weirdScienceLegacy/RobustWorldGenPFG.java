...
public class RobustWorldGenPFG implements IWorldGenerator {
	...
	private static ArrayList<RobustWorldGenPFG> generators = new ArrayList<RobustWorldGenPFG>();

	public static void generateAll(Random fmlRandom, int chunkXPos, int chunkZPos, WorldServer world, boolean b) {
		synchronized (RobustWorldGenPFG.generators) {
			for (RobustWorldGenPFG gen : RobustWorldGenPFG.generators) {
				gen.generate(fmlRandom, chunkXPos, chunkZPos, world, b);
			}
		}
	}

	public RobustWorldGenPFG(Block block, int metaId, int[] generationInfo, String dimensionsInfo) {
		this.genBlock = block;
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider) {
		RobustWorldGenPFG.generators.add(this);
