package mortvana.projectfluxgear.to_refactor.weirdScienceLegacy;
...
import mortvana.projectfluxgear.to_refactor.util.legacy.block.tile.TileEntitySolidFueled;
import mortvana.projectfluxgear.to_refactor.util.legacy.item.ISolidFuelInfo;
import mortvana.projectfluxgear.to_refactor.util.legacy.item.SolidFuelInfo;
...
public class TileEntityGunpowderEngine extends TileEntitySolidFueled implements ISidedInventory {
	...
	/*//Do metadata things to our block, changing its assets.mortvana.fluxgearzee.textures based on if the engine is on or off.
