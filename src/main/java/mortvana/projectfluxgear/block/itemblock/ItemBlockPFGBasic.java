...
public class ItemBlockPFGBasic {
	...
	public static String unlocDefault = "tile.mortvana.projectfluxgear.block.";
	public static String unlocOre = "tile.mortvana.projectfluxgear.ore.";
	public static String unlocStore = "tile.mortvana.projectfluxgear.storage.";
	public static String unlocGravel = "tile.mortvana.projectfluxgear.oreGravel.";
	public static String unlocPoore = "tile.mortvana.projectfluxgear.orePoor.";
}
