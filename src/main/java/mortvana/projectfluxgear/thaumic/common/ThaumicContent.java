...
public class ThaumicContent {
	...
	public static CreativeTabs thaumicRevelationsTab = new FluxGearTab("PFG-Thaumic", "fluxgear.tabThaumic", new ItemStack(oldcode.projectfluxgear.thaumic.ThaumicContent.itemWardenAmulet));
