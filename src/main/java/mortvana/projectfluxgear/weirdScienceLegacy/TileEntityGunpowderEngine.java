...
import mortvana.projectfluxgear.util.legacy.block.tile.TileEntitySolidFueled;
import mortvana.projectfluxgear.util.legacy.item.ISolidFuelInfo;
import mortvana.projectfluxgear.util.legacy.item.SolidFuelInfo;
