...
public class LoadedHelper {
	...
	public static boolean isExtraTreesLoaded = Loader.isModLoaded("ExtraTrees");
	...
	public static boolean isProjectRedIllumination = Loader.isModLoaded("ProjRed|Illumination");

	/* OreDict Helper */
	public static boolean isSteelRegistered = !OreDictionary.getOres("ingotSteel").isEmpty();
	public static boolean isCopperRegistered = !OreDictionary.getOres("ingotCopper").isEmpty();
	public static boolean isNickelRegistered = !OreDictionary.getOres("ingotNickel").isEmpty();
	public static boolean isSiliconRegistered = !OreDictionary.getOres("itemSilicon").isEmpty();
	public static boolean isDamascusSteelRegistered = !OreDictionary.getOres("ingotDamascusSteel").isEmpty();
	public static boolean isInvarRegistered = !OreDictionary.getOres("ingotInvar").isEmpty();
}
