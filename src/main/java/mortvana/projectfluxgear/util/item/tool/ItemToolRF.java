package mortvana.projectfluxgear.util.item.tool;

/*import cofh.appeng.api.energy.IEnergyContainerItem;
import cofh.appeng.api.item.IEmpowerableItem;
import cofh.item.tool.ItemToolAdv;
import cofh.util.*;
import com.google.common.collect.HashMultimap;
import com.google.common.collect.Multimap;
import net.minecraft.block.Block;
import net.minecraft.gui.renderer.texture.IIconRegister;
...
/*public abstract class ItemToolRF extends ItemToolAdv implements IEmpowerableItem, IEnergyContainerItem {
    ...
    @Override
    public int getDisplayDamage(ItemStack stack) { //TODO: Get Lemming to use the new form
