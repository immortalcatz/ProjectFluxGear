package mortvana.projectfluxgear.util.repack.pulsar.control;
...
import mortvana.projectfluxgear.util.repack.pulsar.config.IConfiguration;
import mortvana.projectfluxgear.util.repack.pulsar.internal.Configuration;
import mortvana.projectfluxgear.util.repack.pulsar.internal.logging.ILogger;
import mortvana.projectfluxgear.util.repack.pulsar.internal.logging.LogManager;
import mortvana.projectfluxgear.util.repack.pulsar.pulse.*;
...
public class PulseManager {
     ...
     * Whatever really. See {@link mortvana.projectfluxgear.util.repack.pulsar.config.IConfiguration}.
     *
     * @param modId The parents ModID.
