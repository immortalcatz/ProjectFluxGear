package mortvana.projectfluxgear.util.repack.pulsar.config;
...
/**
 * Pulsar addon class to support using the forge CFG format for configurations, taken from Mantle
 * @author progwml6
 */
