...
import mortvana.fluxgearcore.legacy.block.IMagnequasarBlock;
import mortvana.fluxgearcore.legacy.fluid.BucketEventManager;
...
import mortvana.fluxgearcore.legacy.util.chemistry.reaction.IReactionReceiver;
import mortvana.fluxgearcore.legacy.util.chemistry.reaction.IReactionSpec;
...
import mortvana.fluxgearcore.legacy.item.ISubBucket;
import mortvana.fluxgearcore.legacy.item.ISubItem;
import mortvana.fluxgearcore.legacy.item.IWeirdScienceItem;
import mortvana.fluxgearcore.legacy.util.crafting.IRecipeProvider;
import mortvana.fluxgearcore.legacy.util.crafting.IWorkbenchRecipe;
...
public class ContentRegistry implements IFuelHandler
{
    ...
    protected void FinalizeBlocks ()
    {
        for (int i = 0; i < blocksToRegister.size(); ++i)
        {
            ...
            if (b instanceof IMagnequasarBlock)
            {
                IMagnequasarBlock wsb = (IMagnequasarBlock) b;
