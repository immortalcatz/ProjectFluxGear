...
import mortvana.fluxgearcore.util.world.PoorNetherOreGenerator;
import mortvana.fluxgearcore.util.world.PoorOreGenerator;
...
public class PoorOreGen {
	...
	public static final int[] DENSITY = { 16, 12, 8, 7, 7, 9, 9, 9, 10, 2, 8, 6, 6, 2, 2, 2, 4, 12, 6, 6, 6, 4, 8, 8, 8, 7, 7, 6, 8, 4, 4, 2};
	public static final int[] SEED = { 682, 526, 261, 334, 706, 324, 282, 887, 712, 175, 803, 568, 767, 297, 740, 910, 720, 187, 633, 741, 934, 647, 218, 554, 505, 948, 499, 822, 291, 798, 274, 946 };
