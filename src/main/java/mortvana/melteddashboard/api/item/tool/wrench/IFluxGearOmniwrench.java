 ...
 *  EnderIO compatible tool-thingy, Railcraft crowbar, Project:Red screwdriver, and Flaxbeard's Steam Power pipe wrench.
 *
 *  @author Mortvana
 */
public interface IFluxGearOmniwrench extends IFluxGearMultiwrench, IToolCrowbar, IScrewdriver, IPipeWrench {}
