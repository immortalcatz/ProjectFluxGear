...
public class MaterialData {
	...
	public final MaterialSet CAST_INGOT = new MaterialSet(ingot, 6000, "castIngot", 0);
	public final MaterialSet INGOT_PILE = new MaterialSet(ingot, 8000, "pileIngot", 0);
	public final MaterialSet LARGE_INGOT = new MaterialSet(ingot, 10000, "largeIngot", 0);
