package mortvana.legacy.clean.morttech.util.handlers;
...
//TODO: Much Uncommentcern Doge...
public abstract class MTKeyHandler {
     ...
     * @param repeatings
     */
    public MTKeyHandler(KeyBinding[] keyBindings, boolean[] repeatings, KeyBinding[] vanillaKeys, boolean[] vanillaRepeatings)
    {
     ...
     * @param keyBindings
     */
    public MTKeyHandler(KeyBinding[] keyBindings)
    {
        this.keyBindings = keyBindings;
        this.isDummy = true;
    }
