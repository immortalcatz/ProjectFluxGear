...
public class VersionInfo {
    ...
    public static final String VersionURL = "Coming Soon";

    public static final String Logo = "/gfx/mortvanabees/logo.png";

    public static final String Depends = "required-after:Forestry; after:BigReactors";
    ...
    public static void doVersionCheck()  {
        ...
        MinecraftForge.EVENT_BUS.register(TickHandlerVersion.instance);
