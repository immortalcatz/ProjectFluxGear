package mortvana.legacy.refactored.wierdscience.util;
...
@Deprecated
//TODO: Clean, refactor, reimplement
//A singleton
public class HeatBehaviorRegistry {
     ...
     * 
     * Gyro sayas: (p.s. Java now has the distinction of being more temperamental than C++,
