package mortvana.legacy.refactored.core.common;

import java.io.File;

import net.minecraftforge.common.config.Configuration;

import mortvana.legacy.util.handlers.LogHandler;
...
public class FluxGearConfig {
	...
	public static void loadConfig (File file) {
		...
		initMachines(new Configuration(new File(file, "Machines")));
		...
		MeltedDashboardCore.logger.info("Configuration load completed.");
	}
