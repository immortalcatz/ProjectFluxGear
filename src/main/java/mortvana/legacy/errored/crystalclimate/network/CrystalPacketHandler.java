package mortvana.legacy.errored.crystalclimate.network;
...
public class CrystalPacketHandler implements IPacketHandler {
	...
	public void onPacketData(NetworkManager manager, Packet250CustomPayload packet, Player player) {
		...
		if (packet.channel.equals("CrystalClimate")) {
			side == Side.SERVER ? handleServerPacket(packet, (EntityPlayerMP) player) : handleClientPacket(packet, (EntityPlayer) player);
		}
	}
