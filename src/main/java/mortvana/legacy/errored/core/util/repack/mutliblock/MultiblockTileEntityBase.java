...
public abstract class MultiblockTileEntityBase extends IMultiblockPart {
	...
	public void assertDetached() {
		if(this.controller != null) {
			MeltedDashboardLib.log.info("[assert] Part @ (%d, %d, %d) should be detached already, but detected that it was not. This is not a fatal error, and will be repaired, but is unusual.", xCoord, yCoord, zCoord);
