...
import mortvana.legacy.errored.thermaltinkerer.item.ItemInteractivePFG;
import mortvana.legacy.errored.thermaltinkerer.item.ItemPrototypeSonicWrench;
import mortvana.legacy.refactored.core.common.FluxGearConfig;
import mortvana.legacy.refactored.morttech.block.BlockMortTechOre;
import mortvana.legacy.refactored.morttech.item.DebuggingSpork;
import mortvana.legacy.refactored.morttech.item.ItemDust;
import mortvana.legacy.refactored.paintedstone.item.ItemPaintbrush;
import mortvana.legacy.refactored.wierdscience.block.BlockGunpowderEngine;
import mortvana.legacy.refactored.wierdscience.block.BlockNitrateEngine;
import mortvana.legacy.refactored.wierdscience.block.BlockOccultEngine;
...
import mortvana.legacy.refactored.morttech.block.itemblock.ItemBlockBasicOre;
import mortvana.legacy.refactored.morttech.block.itemblock.ItemBlockComplexOre;
import mortvana.legacy.refactored.morttech.block.itemblock.ItemBlockGemOre;
...
import mortvana.legacy.errored.morttech.item.*;
import mortvana.legacy.errored.paintedstone.recipe.RecipePaintbrush;
import mortvana.legacy.util.ContentRegistry;
import mortvana.legacy.refactored.wierdscience.util.chemistry.ReactionSpec;
...
public class FluxGearContent implements IFuelHandler {
	...
	public static void preInitMortTech() {
		...
		tileCrank = new BlockCrank(Material.wood).setResistance(5.0f).setCreativeTab(machineTab).setHardness(2.3f).setBlockName("Crank");
		GameRegistry.registerBlock(tileCrank, "tempCrank");

		tileMachineTier0 = new BlockWoodmill().setResistance(5.0f).setCreativeTab(machineTab).setHardness(2.3f).setBlockName("Woodmill");
