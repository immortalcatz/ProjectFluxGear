package mortvana.legacy.dependent.seconddegree.core.util.handlers;
...
import mortvana.legacy.clean.core.util.wrappers.BlockWrapper;
import mortvana.legacy.dependent.firstdegree.core.util.wrappers.ItemWrapper;
