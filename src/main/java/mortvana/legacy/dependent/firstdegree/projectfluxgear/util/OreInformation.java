...
public class OreInformation {
    ...
    public static OreBlockEntry oreEntryMain = new OreBlockEntry(FluxGearContent.blockOreMain, BlockInformation.itemBlockOreMain, "OreMain", "pickaxe");
    public static OreBlockEntry oreEntryAux = new OreBlockEntry(FluxGearContent.blockOreAux, BlockInformation.itemBlockOreAux, "OreAux", "pickaxe");
    public static OreBlockEntry oreEntryEarthen = new OreBlockEntry(FluxGearContent.blockEarthen, BlockInformation.itemBlockEarthen, "Earthen", "shovel");
    public static OreBlockEntry oreEntryPoorMain = new OreBlockEntry(FluxGearContent.blockPoorOreMain, BlockInformation.itemBlockPoorOreMain, "PoorOreMain", "pickaxe");
    public static OreBlockEntry oreEntryPoorAux = new OreBlockEntry(FluxGearContent.blockPoorOreAux, BlockInformation.itemBlockPoorOreAux, "PoorOreAux", "pickaxe");
    public static OreBlockEntry oreEntryGravelMain = new OreBlockEntry(FluxGearContent.blockGravelOreMain, BlockInformation.itemBlockGravelOreMain, "GravelOreMain", "shovel");
    public static OreBlockEntry oreEntryGravelAux = new OreBlockEntry(FluxGearContent.blockGravelOreAux, BlockInformation.itemBlockGravelOreAux, "GravelOreAux", "shovel");
