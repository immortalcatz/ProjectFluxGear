...
import crystal.block.logic.EssenceExtractorLogic;
...
public class EssenceExtractor extends BlockContainer {
	...
	public void onBlockClicked(World world, int x, int y, int z, EntityPlayer player) {
		if (world.isRemote) {
			...
			if (amount > 0) {
				ItemStack crystal = new ItemStack(CrystalContent.essenceCrystal, 1);
	...
	public void registerIcons(IconRegister par1IconRegister) {
		this.blockIcon = par1IconRegister.registerIcon("crystal:extractor_side");
		this.field_94461_a = par1IconRegister.registerIcon("crystal:extractor_top");
		this.field_94460_b = par1IconRegister.registerIcon("crystal:extractor_bottom");
	}
}
