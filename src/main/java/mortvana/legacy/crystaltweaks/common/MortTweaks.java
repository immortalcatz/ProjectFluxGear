package mortvana.legacy.crystaltweaks.common;
...
public class MortTweaks {
	@SidedProxy(clientSide = "mortvana.tweaks.cleint.ClientProxy", serverSide = "mortvana.mortvana.legacy.crystaltweaks.common.CommonProxy")
