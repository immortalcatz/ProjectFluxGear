package mortvana.tweaks.common;
...
public class CommonProxy {
	...
	public void onLivingDrop(LivingDropsEvent event) {
		...
		if (MortTweaks.leather && living instanceof EntityCow) {
			...
			if (MortTweaks.feathers && living.getClass() == EntityChicken.class) {
				...
				if (living instanceof EntityEnderman) {
					...
					if (MortTweaks.animalBones && living instanceof EntityAnimal) {
						...
						if (MortTweaks.fleshToFeathers && event.entityLiving instanceof EntityZombie) {
	...
	public void onLivingSpawn(LivingSpawnEvent.SpecialSpawn event) {
		...
		if (MortTweaks.mounts) {
			...
			if (living.getClass() == EntitySpider.class && random.nextInt(100) == 0) {
				...
				if (living.getClass() == EntitySlime.class) {
