...
import mortvana.legacy.refactored.wierdscience.block.tileentity.TileEntityBloodDynamo;
import mortvana.legacy.refactored.wierdscience.block.tileentity.TileEntityOccultEngine;
...
import mortvana.legacy.refactored.wierdscience.util.chemistry.IBioactive;
	...
	public class BlockPaintedStone extends Block {
		...
		public void registerBlockIcons(IIconRegister iconRegister) {
			...
			for(int i = 0; i < this.icons.length; ++i) {
				this.icons[i] = iconRegister.registerIcon("mortvana.mechstoneworks:" + textureName + "_" + mortvana.legacy.errored.core.common.ProjectFluxGear.colorNames[i]);
			}
